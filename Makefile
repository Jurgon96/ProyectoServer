...
rcftpclient: rcftpclient.o rcftp.o multialarm.o misfunciones.o
	$(CC) $(RCFTPOPT) -o rcftpclient rcftpclient.o rcftp.o multialarm.o misfunciones.o
...
clean:
	-rm -f rcftpclient rcftpclient.o rcftp.o multialarm.o misfunciones.o "tareaRC_${LOGNAME}.tar.gz" 
